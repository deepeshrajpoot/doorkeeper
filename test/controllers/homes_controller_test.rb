...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { email: @home.email, first_name: @home.first_name, last_name: @home.last_name } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { email: @home.email, first_name: @home.first_name, last_name: @home.last_name } }
